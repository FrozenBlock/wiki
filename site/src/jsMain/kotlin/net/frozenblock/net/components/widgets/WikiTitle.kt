...
import net.frozenblock.net.pages.TopHeroContainerVariant
...
fun WikiTitle(
    ...
    Row(HeroContainerStyle.toModifier(TopHeroContainerVariant), horizontalArrangement = Arrangement.Center) {
